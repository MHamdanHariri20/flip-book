        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="{{url('/dashboard/admin/home')}}" aria-expanded="false">
                <span>
            ...
            <ul id="dynamicAddRemove">
              <li class="sidebar-item" data-id="1">
                <a class="sidebar-link" href="{{url('/dashboard/admin/flipbook')}}" style="width: 70%;" aria-expanded="false">
                  <span>
            ...
            <li class="nav-small-cap">
              ...
              <li class="sidebar-item">
                <a class="sidebar-link" href="{{url('/dashboard/admin/account')}}" aria-expanded="false">
                  <span>
          ...
          <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
            <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
              <li class="nav-item dropdown d-flex align-items-center">
                <p class="mb-0 fs-3">Hi, {{Auth::user()->nama}} </p>
...
$(document).ready(function () {
    ...
    if (storedIds) {
        ...
        updateSidebarLinks(); // Memperbarui tautan sidebar dengan data yang disimpan
    }
    ...
    function loadContent(url) {
        $('#content').load(url); // Menggunakan metode load untuk memuat konten

        // Menghapus elemen sidebar-link yang di-generate oleh append sebelumnya
        $('#dynamicAddRemove').find('.sidebar-link').remove();
        // Menambahkan elemen sidebar-link yang sesuai dengan daftar ids
        updateSidebarLinks();
    }
